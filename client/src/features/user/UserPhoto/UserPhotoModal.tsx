...
import { Modal, FileUploader } from "@features/ui";
import { UserPhotoDisplay, useUserServices } from "@features/user";
...
const UserPhotoModal: React.FC<UserPhotoModalProps> = ({
  ...
  const onNewImageSubmit = () => changeUserImage(newImageFile);
